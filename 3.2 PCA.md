...
popmapcolor <- popmapcolor[order( popmapcolor[,2],popmap[,1]),] #order the individulas in popcolor in the second column according to the order that can be found in popmap's first colum
